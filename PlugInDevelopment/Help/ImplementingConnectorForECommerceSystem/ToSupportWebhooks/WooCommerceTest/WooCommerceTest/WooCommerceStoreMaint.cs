...
namespace WooCommerceTest
{
    public class WooCommerceStoreMaint : BCStoreMaint
    {
        ...
        public SelectFrom<BCBindingWooCom>.
            Where<BCBindingWooCom.bindingID.
        ...
        protected virtual IEnumerable testConnection(PXAdapter adapter)
        {
            ...
            BCBindingWooCom bindingWooCommerce = CurrentBindingWooCommerce.Current ?? CurrentBindingWooCommerce.Select();
            ...
            PXLongOperation.StartOperation(this, delegate
            {
                ...
                try
                {
                    ...
                    graph.CurrentBindingWooCommerce.Cache.SetValueExt(binding, nameof(BCBindingWooCom.wooCommerceDefaultCurrency), systemStatus.Settings.Currency);
                    graph.CurrentBindingWooCommerce.Cache.SetValueExt(binding, nameof(BCBindingWooCom.wooCommerceStoreTimeZone), systemStatus.Environment.DefaultTimezone);
        ...
        protected virtual void _(Events.RowPersisting<BCBindingWooCom> e)
        {
            BCBindingWooCom row = e.Row as BCBindingWooCom;
