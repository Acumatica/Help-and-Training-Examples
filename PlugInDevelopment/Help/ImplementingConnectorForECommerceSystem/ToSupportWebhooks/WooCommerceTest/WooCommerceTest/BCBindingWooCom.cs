...
namespace WooCommerceTest
{
    ...
    public class BCBindingWooCom : IBqlTable
    {
        public class PK : PrimaryKeyOf<BCBindingWooCom>.By<BCBindingWooCom.bindingID>
        {
            public static BCBindingWooCom Find(PXGraph graph, int? binding) => FindBy(graph, binding);
        }
        ...
        [PXParent(typeof(Select<BCBinding, Where<BCBinding.bindingID, Equal<Current<BCBindingWooCom.bindingID>>>>))]
