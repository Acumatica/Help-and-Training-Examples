...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXFormView Width="100%" runat="server" ID="CstFormView1" DataMember="Filter">
		<Template>
			<px:PXLayoutRule runat="server" ID="CstPXLayoutRule6" StartRow="True" ControlSize="S" LabelsWidth="XM" ></px:PXLayoutRule>
	...
	<px:PXGrid AdjustPageSize="Auto" AllowPaging="True" ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" AllowAutoHide="false">
		<Levels>
			<px:PXGridLevel DataMember="WorkOrders">
				...
				<px:PXGridColumn CommitChanges="" DataField="Assignee" Width="140" ></px:PXGridColumn>
				<px:PXGridColumn DataField="DefaultAssignee" Width="100" ></px:PXGridColumn>
