	...
	<px:PXGrid SyncPosition="True" AdjustPageSize="Auto" AllowPaging="True" ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" AllowAutoHide="false">
		<Levels>
			<px:PXGridLevel DataMember="WorkOrders">
				...
				<px:PXGridColumn DataField="TimeWithoutAction" Width="70" ></px:PXGridColumn></Columns>
			
				<RowTemplate>
					<px:PXSelector AutoRefresh="True" runat="server" ID="CstPXSelector5" DataField="Assignee" ></px:PXSelector>
								<px:PXSelector AutoRefresh="True" runat="server" ID="CstPXSelector6" DataField="AssignTo" ></px:PXSelector></RowTemplate></px:PXGridLevel>
		</Levels>
