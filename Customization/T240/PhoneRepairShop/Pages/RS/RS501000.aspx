...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXFormView runat="server" ID="CstFormView1" DataSourceID="ds" DataMember="Filter" Width="100%" >
		<Template>
			<px:PXLayoutRule ControlSize="S" LabelsWidth="XM" runat="server" ID="CstPXLayoutRule2" StartRow="True" ></px:PXLayoutRule>
			<px:PXDropDown AllowEdit="True" CommitChanges="True" runat="server" ID="CstPXDropDown6" DataField="Priority" ></px:PXDropDown>
			<px:PXNumberEdit CommitChanges="True" runat="server" ID="CstPXNumberEdit8" DataField="TimeWithoutAction" ></px:PXNumberEdit>
			<px:PXLayoutRule runat="server" ID="CstPXLayoutRule9" StartColumn="True" ></px:PXLayoutRule>
			<px:PXSelector CommitChanges="True" runat="server" ID="CstPXSelector7" DataField="ServiceID" ></px:PXSelector></Template></px:PXFormView>
	<px:PXGrid SyncPosition="True" ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" AllowAutoHide="false">
		<Levels>
			<px:PXGridLevel DataMember="WorkOrders">
				...
				<px:PXGridColumn DataField="OrderNbr" Width="72" ></px:PXGridColumn>
				...
				<px:PXGridColumn DataField="TimeWithoutAction" Width="100" ></px:PXGridColumn>
				<px:PXGridColumn DataField="NbrOfAssignedOrders" Width="100" ></px:PXGridColumn></Columns>
			
				<RowTemplate>
								<px:PXSelector runat="server" ID="CstPXSelector11" DataField="AssignTo" AutoRefresh="True" ></px:PXSelector></RowTemplate></px:PXGridLevel>
		</Levels>
