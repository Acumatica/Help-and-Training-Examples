	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" AllowAutoHide="false">
		<Items>
			...
			<px:PXTabItem Text="Payment Info">
				<Template>
					<px:PXFormView runat="server" ID="CstFormView25" DataMember="Payments" >
						<Template>
							<px:PXTextEdit runat="server" ID="CstPXTextEdit29" DataField="InvoiceNbr" />
							<px:PXDateTimeEdit runat="server" ID="CstPXDateTimeEdit28" DataField="DueDate" />
							<px:PXTextEdit runat="server" ID="CstPXTextEdit26" DataField="AdjgRefNbr" />
							<px:PXNumberEdit runat="server" ID="CstPXNumberEdit27" DataField="CuryAdjdAmt" /></Template></px:PXFormView></Template></px:PXTabItem></Items>
