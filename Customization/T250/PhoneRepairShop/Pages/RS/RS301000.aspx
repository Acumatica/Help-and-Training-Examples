...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" AllowAutoHide="true">
		<Items>
			...
			<px:PXTabItem RepaintOnDemand="false" Text="Payment Info" >
				<Template>
					<px:PXFormView DataSourceID="ds" runat="server" ID="CstFormView34" DataMember="Payments" RenderStyle="Fieldset"  >
						<Template>
                            <px:PXLayoutRule runat="server" ID="CstPXLayoutRule42" StartColumn="True" ControlSize="M" ></px:PXLayoutRule>
							<px:PXTextEdit runat="server" ID="CstPXTextEdit37" DataField="InvoiceNbr" ></px:PXTextEdit>
							<px:PXDateTimeEdit runat="server" ID="CstPXDateTimeEdit36" DataField="DueDate" ></px:PXDateTimeEdit>
							<px:PXTextEdit runat="server" ID="CstPXTextEdit38" DataField="AdjgRefNbr" ></px:PXTextEdit>
							<px:PXNumberEdit runat="server" ID="CstPXNumberEdit39" DataField="CuryAdjdAmt" ></px:PXNumberEdit></Template></px:PXFormView>
