	...
	<Levels>
      <px:PXGridLevel DataMember="DetailsView">
          <Columns>
              ...
              <px:PXGridColumn LinkCommand="ViewOrder" DataField="OrderNbr" Width="72" ></px:PXGridColumn>
              <px:PXGridColumn DataField="Status" Width="140" ></px:PXGridColumn>
              <px:PXGridColumn DataField="InvoiceNbr" Width="72" CommitChanges="True" ></px:PXGridColumn>
              <px:PXGridColumn DataField="PercentPaid" Width="72" ></px:PXGridColumn>
              <px:PXGridColumn DataField="ARInvoice__DueDate" Width="72" ></px:PXGridColumn>
              <px:PXGridColumn DataField="ARInvoice__CuryDocBal" Width="100" ></px:PXGridColumn>
          </Columns>
          <RowTemplate>
            <px:PXSelector ID="edInvoiceNbr" runat="server"
                DataField="InvoiceNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
          </RowTemplate>
      </px:PXGridLevel>
    </Levels>
