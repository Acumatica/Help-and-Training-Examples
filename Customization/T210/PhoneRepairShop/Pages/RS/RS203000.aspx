...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="RepairPrices" Width="100%" Height="100px">
		<Template>
						...
						<Levels>
							<px:PXGridLevel DataMember="Warranty" >
								<Columns>
									...
									<px:PXGridColumn DataField="ContractTemplate__Description" Width="220" />
									<px:PXGridColumn DataField="ContractTemplate__Duration" Width="70" />
									<px:PXGridColumn DataField="ContractTemplate__DurationType" Width="70" />
									<px:PXGridColumn DataField="ContractTemplate__Type" Width="70" /></Columns></px:PXGridLevel></Levels>
