...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Setup" Width="100%" AllowAutoHide="false">
		<Template>
			...
			<px:PXSelector runat="server" ID="CstPXTextEdit2" DataField="NumberingId" AllowEdit="true"></px:PXSelector>
			<px:PXSegmentMask runat="server" ID="CstPXSegmentMask3" DataField="WalkInCustomerID" ></px:PXSegmentMask>
			<px:PXSelector runat="server" ID="CstPXSelector3" DataField="DefaultEmployee" ></px:PXSelector>
			<px:PXNumberEdit runat="server" ID="CstPXNumberEdit4" DataField="PrepaymentPercent" ></px:PXNumberEdit></Template>
