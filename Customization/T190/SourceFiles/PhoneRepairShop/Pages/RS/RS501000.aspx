...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXFormView runat="server" ID="CstFormView1" DataSourceID="ds" DataMember="Filter" Width="100%" >
		<Template>
			<px:PXLayoutRule LabelsWidth="XM" runat="server" ID="CstPXLayoutRule5" StartRow="True" ></px:PXLayoutRule>
	...
	<px:PXGrid SyncPosition="True" ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" AllowAutoHide="false">
		<Levels>
			<px:PXGridLevel DataMember="WorkOrders">
				...
				<px:PXGridColumn DataField="TimeWithoutAction" Width="120" ></px:PXGridColumn>
				<px:PXGridColumn CommitChanges="True" DataField="AssignTo" Width="140" ></px:PXGridColumn>
				<px:PXGridColumn DataField="NbrOfAssignedOrders" Width="150" ></px:PXGridColumn></Columns>
				<RowTemplate>
